...
<div class="appbar"><div class="in">
  ...
  <div class="seg" id="viewseg">
    <button data-v="funds" class="on">Investors</button><button data-v="htc">H2C paths</button><button data-v="unt">Untracked</button>
  </div>
...
function detailHTML(e){
  ...
  {const pq = encodeURIComponent('Use the fund-portfolio-prep skill: prep my meeting with '+e.name);
  h += `<div class="actionrow" style="margin-top:14px"><a class="minibtn prep" href="claude://cowork/new?q=${pq}">⚡ Prep brief in Cowork</a><a class="minibtn" href="https://claude.ai/new?q=${pq}" target="_blank" rel="noopener">or in browser</a><span class="cc" style="align-self:center">prefills the prep request — just hit send</span></div>`;}
  return h;
}
