...
function detailHTML(e){
  ...
  h += `<div class="actionrow" style="margin-top:14px"><a class="minibtn prep" href="https://claude.ai/new?q=${encodeURIComponent('Prep my meeting with '+e.name)}" target="_blank" rel="noopener">⚡ Prep brief in Claude</a><span class="cc" style="align-self:center">opens Claude with the meeting-prep request ready to send</span></div>`;
  return h;
}
